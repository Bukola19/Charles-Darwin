...
for sample in "${SAMPLES[@]}";do
    ...
    #read1_url="https://zenodo.org/records/10426436/files/${sample}_1.fastq.gz"
    read2_url="https://github.com/josoga2/yt-dataset/raw/main/dataset/raw_reads/${sample}_R2.fastq.gz"
    #read2_url="https://zenodo.org/records/10426436/files/${sample}_2.fastq.gz"
...
#ref_url="https://zenodo.org/records/10886725/files/Reference.fasta"
